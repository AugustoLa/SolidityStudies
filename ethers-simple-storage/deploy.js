        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    encryptedJson = fs.readFileSync(
                        "./.encryptedKey.json",
                        "utf8"
                    )
                    wallet = ethers_1.ethers.Wallet.fromEncryptedJsonSync(
                        encryptedJson,
                    ...
                    contractFactory = new ethers_1.ethers.ContractFactory(
                        abi,
                        binary,
                        wallet
                    )
                ...
                case 2:
                    ...
                    console.log(
                        "Current favorite Number: ".concat(
                ...
                case 4:
                    ...
                    return [4 /*yield*/, contract.retrieve()]
                case 5:
                    updatedFavoritNumber = _a.sent()
                    console.log(
                        "Updated favorite number is: ".concat(
                            updatedFavoritNumber
                        )
                    )
                    return [2 /*return*/]
